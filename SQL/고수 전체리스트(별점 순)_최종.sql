-- 별점 높은 순서로 고수번호, 고수 사진, 고수 이름, 고수 분야, 고수 지역, 고수 한줄 소개, 고수 레슨 관련 리뷰(가장 최근에 달린 리뷰 1개), 평균 별점, 리뷰 개수, 고수 지원 서비스 정렬
...
left outer join
	(
    select r1.review_idx, r1.mento_idx as midx, review_cont from toti.toti_review r1
	where  r1.review_idx =
		(
