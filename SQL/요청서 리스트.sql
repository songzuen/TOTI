SELECT a.request_idx,m.m_idx, m_name, m_photo, c.cate_name, quest_name, answer_cont, service_name, request_date FROM toti.toti_answer a left outer join toti.toti_question q on q.quest_idx = a.quest_idx 
