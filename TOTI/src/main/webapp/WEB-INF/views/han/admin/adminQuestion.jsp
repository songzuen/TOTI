...
<body>
	...
	<script>
		...
		function itemByQuest(quest_idx){
			$.ajax({
				url : 'http://13.209.47.16:8080/toti/admin/question/itemlist/'+quest_idx,
				type : 'GET',
				success : function(data){
					var html = '';
		...
		function delitem(item_idx){
			if(confirm('답변 항목을 삭제할까요?')){
				$.ajax({
					url : 'http://13.209.47.16:8080/toti/admin/question/deleteItem/'+item_idx,
					type : 'DELETE',
					success : function(data){
						if(data=='success'){
		...
		function additem() {
			$.ajax({
				url : 'http://13.209.47.16:8080/toti/admin/question/insertItem',
				type : 'POST',
