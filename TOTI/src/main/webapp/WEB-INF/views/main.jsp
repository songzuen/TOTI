...
<head>
<%
	System.out.println("id의 세션 = "+session.getAttribute("id"));
	System.out.println("idx의 세션 = "+session.getAttribute("idx"));
	System.out.println("name의 세션 = "+session.getAttribute("name"));
	System.out.println("photo_name의 세션 = "+session.getAttribute("photo_name"));
            ...
            <div class="row">
                <div class="main-slider">
                    <div class="slide-text">
                        ...
                        <a href="<c:url value="reg" />" class="btn btn-common">SIGN UP</a>
                    </div>
